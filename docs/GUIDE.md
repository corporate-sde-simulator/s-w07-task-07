...
> **Welcome to Service-Track Week 7, Task 7!**
...
| `src/paginationEngine.py` | Main source code - **has bugs to fix** |
| `src/resultSerializer.py` | Supporting code - **may also have bugs** |
| `tests/paginationOptimizer.test.ts` | Test file - **add your tests here** |
